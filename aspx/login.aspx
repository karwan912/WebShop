...
<div class="row">
	...
	<div class="row">
		<div class="col-md-12 img-bg-login">
			<div class="row">
				<div class="col-md-6">
				</div>
				<div class="col-md-4 login-box-style-my">
					<form role="form">
						...
						<div class="form-group">
							...
							<input type="password" class="form-control" id="exampleInputPassword1" runat="server" />
						</div>
						
						<div class="checkbox">
							 
							<label>
								<input type="checkbox" /> 7天免密码登陆
							</label>
						</div> 
					...
					<p class="help-block">
								<a class="a-style-my2 float-right" href="../aspx/registered.aspx">怎么？还没注册？点击注册一个</a>
							</p>
				</div>
				<div class="col-md-2">
				</div>
